...
class Controller extends BaseController
{
    ...
    public function get_charities()
    {
        try {
            ...
            ->select('charities.id', 'organization', 'contact_number', 'account_name', 'account_number', 'users.name as handler', 'charity_categories.name as category', 'charities.photo', 'address', 'points')
            ->get();
